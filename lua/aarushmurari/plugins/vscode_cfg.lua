if vim.g.vscode then
    ...
    keymap.set("n", "<leader>vee", lua function() local vscode = require('vscode') vscode.call('workbench.view.explorer') vscode.call('workbench.files.action.showActiveFileInExplorer') end, { noremap = true, silent = true, desc = "Toggle file explorer" }) -- toggle file explorer
